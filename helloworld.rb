...
get '/:var' do
	...
	if par == "leche"
		...
		json [{"nombre"=>"Res","source"=>"https://www.info7.mx/foto/560000/567479_carne-res-mexico-rusia.jpg"},{"nombre"=>"Pescado","source"=>"https://chefcgarcia.files.wordpress.com/2011/04/cabeza-pescado.jpg"},{"nombre"=>"Pollo","source"=>"http://www.recetin.com/wp-content/uploads/2014/02/pollo_despiece.jpg"}]
	elsif par == "queso"
